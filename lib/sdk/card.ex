defmodule WeChat.SDK.Card do
  ...
  @spec batch_get_cards(SDK.client, [card_status], count :: integer, offset :: integer) :: SDK.response
  ...
  """
  @spec update_card_code(SDK.client, card_id, old_code :: card_code, new_code :: card_code) :: SDK.response
  ...
  ## API Docs
    [link](#{@doc_link}/Cards_and_Offer/Managing_Coupons_Vouchers_and_Cards.html#8){:target="_blank"}
  """
  @spec unavailable_card_code(SDK.client, card_id, card_code, reason :: String.t) :: SDK.response
  ...
  """
  @spec get_card_bizuin_info(SDK.client, begin_date :: date, end_date :: date, cond_source) :: SDK.response
  def get_card_bizuin_info(client, begin_date, end_date, cond_source \\ 1) when cond_source in 0..1 do
    client.request(
      :post,
  ...
  """
  @spec get_card_analysis(SDK.client, begin_date :: date, end_date :: date, cond_source) :: SDK.response
  ...
  @spec get_card_analysis(SDK.client, card_id, begin_date :: date, end_date :: date, cond_source) :: SDK.response
  def get_card_analysis(client, card_id, begin_date, end_date, cond_source) when cond_source in 0..1 do
    client.request(
      :post,
      url: "/datacube/getcardcardinfo",
      body: json_map(begin_date: begin_date, end_date: end_date, cond_source: cond_source, card_id: card_id)
    )
  end
  ...
  """
  @spec check_card_code(SDK.client, card_id, card_code, check_consume :: boolean) :: SDK.response
